...
public class PlayerAttributes: MonoBehaviour
{
    ...
    {
        m_dictionaryAttributesProgress.Add(0, new List<float> { 12, 20, 31, 45, 64, 88, 119, 160, 213, 282 });
        m_dictionaryAttributesProgress.Add(1, new List<float> { 1, 1.1f, 1.25f, 1.45f, 1.7f, 2 });
        m_dictionaryAttributesProgress.Add(3, new List<float> { 2, 3 });
        m_dictionaryAttributesProgress.Add(4, new List<float> { 0.9f, 0.8f, 0.7f, 0.6f, 0.5f, 0.4f });
        m_dictionaryAttributesProgress.Add(6, new List<float> { 2, 3, 5 });
        m_dictionaryAttributesProgress.Add(8, new List<float> { 2, 3, 5 });
        m_dictionaryAttributesProgress.Add(9, new List<float> { 2, 3, 4, 5 });
        m_dictionaryAttributesProgress.Add(11, new List<float> { 2, 4, 7, 13, 20 });
        m_dictionaryAttributesProgress.Add(12, new List<float> { 1, 1.2f, 1.5f, 2, 3 });
    }
